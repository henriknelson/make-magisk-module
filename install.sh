...
set_permissions() {
  ...
  ui_print "[4/6] Installing to /system/include..";
  chown -R 0:0 $MODPATH/system/include;
  chmod -R 644 $MODPATH/system/include;
  find $MODPATH/system/include -type f -exec chmod 644 {} +;
  find $MODPATH/system/include -type l -exec chmod 644 {} +;
